...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "CMPE295@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "CMPE295 API";

        private String description = "CMPE295 API documentation";
